...
def TestFunc():
    # pd账号秘钥，请在用户信息页获取
    pd_id = "103341";
    pd_key = "VcZPGg2R7RiJiQDVr+2wKZ0SVkexCSoy";
    app_id = "303541";
    app_key = "8i2wDEQkou6PwFJOAtFRaWr6UDN2z/69";
    ...
    URL = "http://login-user.kugou.com/v1/get_img_code?type=RegCheckCode&appid=1014&codetype=0&t={}".format(
        int(time.time() * 1000)
    )
    print(URL)
